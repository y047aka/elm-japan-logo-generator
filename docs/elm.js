...
var author$project$LogoImage$Custom = F2(
	function (a, b) {
				...
				switch (value) {
					case 'icon':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{usage: author$project$LogoImage$Icon}),
							elm$core$Platform$Cmd$none);
					case 'logo':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{usage: author$project$LogoImage$Logo}),
							elm$core$Platform$Cmd$none);
					case 'connpass':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{usage: author$project$LogoImage$Connpass}),
							elm$core$Platform$Cmd$none);
					default:
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
				...
				switch (value) {
					case 'original':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{pattern: author$project$LogoImage$Original}),
							elm$core$Platform$Cmd$none);
					case 'new':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									pattern: A2(author$project$LogoImage$Custom, 'rgb(18, 147, 216)', '#FFF')
								}),
							elm$core$Platform$Cmd$none);
					case 'prime':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									pattern: A2(author$project$LogoImage$Custom, 'hsl(345, 100%, 37%)', '#FFF')
								}),
							elm$core$Platform$Cmd$none);
					case 'option':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									pattern: A2(author$project$LogoImage$Custom, '#FFF', 'hsl(345, 100%, 37%)')
								}),
							elm$core$Platform$Cmd$none);
					default:
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
...
var author$project$Main$viewPatternSelector = function () {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class(option.value)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									elm$html$Html$Attributes$value(option.value),
									elm_community$html_extra$Html$Events$Extra$onChange(author$project$Main$PatternChanged)
								]),
							_List_Nil),
							elm$html$Html$text(option.text)
						]))
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('pattern-selector')
			]),
		A2(elm$core$List$map, listItem, options));
}();
var author$project$LogoImage$Colors = F4(
	function (blue, green, navy, orange) {
		return {blue: blue, green: green, navy: navy, orange: orange};
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$svg$Svg$Attributes$fill(colors.blue),
				...
				_List_fromArray(
					[
						elm$svg$Svg$Attributes$fill(colors.navy),
				...
				_List_fromArray(
					[
						elm$svg$Svg$Attributes$fill(colors.green),
				...
				_List_fromArray(
					[
						elm$svg$Svg$Attributes$fill(colors.orange),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$svg$Svg$Attributes$transform('translate(440 210) scale(0.6)')
					]),
				_List_fromArray(
					[
...
var author$project$Main$UsageChanged = function (a) {
	return {$: 'UsageChanged', a: a};
};
var author$project$Main$viewUsageSelector = function (model) {
	var options = _List_fromArray(
		[
			{
			svg: author$project$LogoImage$svgIcon(model),
			value: 'icon'
		},
			{
			svg: author$project$LogoImage$svgLogo(model),
			value: 'logo'
		},
			{
			svg: author$project$LogoImage$svgBanner(model),
			value: 'connpass'
		}
		]);
	var listItem = function (option) {
